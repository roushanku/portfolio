...
//     xmlns="http://www.w3.org/2000/svg"
//   >
//     <path d="M24 0L0 24l24 24 24-24L24 0zm0 6.9L41.1 24 24 41.1 6.9 24 24 6.9z" />
//     <path d="M16 24h16v2H16zM16 22h16v-2H16z" />
//   </svg>
// );
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        ...
        >
          ...
          <h3 className="text-2xl md:text-3xl font-semibold text-gray-600 dark:text-gray-300 mb-6">
            Software Developer
          </h3>
